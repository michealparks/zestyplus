import"./disclose-version.Bg9kRutz.js";import{ad as P,c as D,V as h,p as re,X as A,r as se,g as U,N as de,K as T,z as j,L as fe,O as F,Y as ve,M as ue,ae as g,C as pe,af as xe,m as me,F as ee}from"./T.po24HVTg.js";const w=e=>({subscribe:e.subscribe,get current(){return e.current}});let z=0;const $=D(!1),R=D(!1),Y=D(void 0),K=D(0),q=D(0),ie=D([]),X=D(0),{onStart:k,onLoad:L,onError:Z}=P;P.onStart=(e,n,t)=>{k==null||k(e,n,t),R.set(!0),Y.set(e),K.set(n),q.set(t);const o=(n-z)/(t-z);X.set(o),o===1&&$.set(!0)};P.onLoad=()=>{L==null||L(),R.set(!1)};P.onError=e=>{Z==null||Z(e),ie.update(n=>[...n,e])};P.onProgress=(e,n,t)=>{n===t&&(z=t),R.set(!0),Y.set(e),K.set(n),q.set(t);const o=(n-z)/(t-z)||1;X.set(o),o===1&&$.set(!0)};w(R),w(Y),w(K),w(q),w(ie),w(X),w($);new h;new h;new h;new re;new A;new se;new h;new h;new h;new h;new U;new j;new h;T.line={worldUnits:{value:1},linewidth:{value:1},resolution:{value:new U(1,1)},dashOffset:{value:0},dashScale:{value:1},dashSize:{value:1},gapSize:{value:1}};fe.line={uniforms:de.merge([T.common,T.fog,T.line]),vertexShader:`
		#include <common>
