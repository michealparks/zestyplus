import"./disclose-version.CY5IDNoG.js";import{aY as P,h as D,V as h,L as re,M as A,t as le,i as U,a2 as de,a0 as T,W as j,a1 as fe,a3 as F,a4 as ve,d as ue,aZ as g,C as pe,as as xe,D as me,Y as ee}from"./T.y93Wq12a.js";const w=e=>({subscribe:e.subscribe,get current(){return e.current}});let z=0;const $=D(!1),R=D(!1),Y=D(void 0),q=D(0),K=D(0),ie=D([]),X=D(0),{onStart:k,onLoad:L,onError:Z}=P;P.onStart=(e,n,t)=>{k==null||k(e,n,t),R.set(!0),Y.set(e),q.set(n),K.set(t);const o=(n-z)/(t-z);X.set(o),o===1&&$.set(!0)};P.onLoad=()=>{L==null||L(),R.set(!1)};P.onError=e=>{Z==null||Z(e),ie.update(n=>[...n,e])};P.onProgress=(e,n,t)=>{n===t&&(z=t),R.set(!0),Y.set(e),q.set(n),K.set(t);const o=(n-z)/(t-z)||1;X.set(o),o===1&&$.set(!0)};w(R),w(Y),w(q),w(K),w(ie),w(X),w($);new h;new h;new h;new re;new A;new le;new h;new h;new h;new h;new U;new j;new h;T.line={worldUnits:{value:1},linewidth:{value:1},resolution:{value:new U(1,1)},dashOffset:{value:0},dashScale:{value:1},dashSize:{value:1},gapSize:{value:1}};fe.line={uniforms:de.merge([T.common,T.fog,T.line]),vertexShader:`
		#include <common>
...
`;`${g.tonemapping_fragment}${g.colorspace_fragment}`;const Le=`
