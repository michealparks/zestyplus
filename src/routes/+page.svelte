...
<div
	class="absolute top-0 left-0 flex h-screen w-screen flex-col items-center justify-center gap-4 p-4"
	style="
...
>
	<div class="relative w-3/4 sm:w-[40%]">
		...
		<img
			alt=""
			class="absolute right-0 bottom-0 -mr-4 w-[40%]"
			src="/plus.png"
		/>
	</div>
	...
	<div class="flex gap-2">
		<a
			class="btn preset-outlined-primary-500 text-primary-500 flex items-center gap-1 bg-linear-to-br"
			href="/is/lines"
		>
