import"./disclose-version.B1qbiK4R.js";import{x as P,y as D,V as y,q as re,w as A,z as le,d as U,t as de,U as T,m as j,r as fe,v as F,L as ve,k as ue,A as g,C as pe,O as xe,E as me,F as ee}from"./analyser.DHwu5Qc2.js";const ke=(e,n)=>{const t={h:0,s:0,l:0};return e.getHSL(t),t.h=(t.h+n)%1,t.h<0&&(t.h+=1),e.setHSL(t.h,t.s,t.l),e},w=e=>({subscribe:e.subscribe,get current(){return e.current}});let z=0;const $=D(!1),H=D(!1),Y=D(void 0),q=D(0),K=D(0),ie=D([]),X=D(0),{onStart:k,onLoad:L,onError:Z}=P;P.onStart=(e,n,t)=>{k==null||k(e,n,t),H.set(!0),Y.set(e),q.set(n),K.set(t);const o=(n-z)/(t-z);X.set(o),o===1&&$.set(!0)};P.onLoad=()=>{L==null||L(),H.set(!1)};P.onError=e=>{Z==null||Z(e),ie.update(n=>[...n,e])};P.onProgress=(e,n,t)=>{n===t&&(z=t),H.set(!0),Y.set(e),q.set(n),K.set(t);const o=(n-z)/(t-z)||1;X.set(o),o===1&&$.set(!0)};w(H),w(Y),w(q),w(K),w(ie),w(X),w($);new y;new y;new y;new re;new A;new le;new y;new y;new y;new y;new U;new j;new y;T.line={worldUnits:{value:1},linewidth:{value:1},resolution:{value:new U(1,1)},dashOffset:{value:0},dashScale:{value:1},dashSize:{value:1},gapSize:{value:1}};fe.line={uniforms:de.merge([T.common,T.fog,T.line]),vertexShader:`
		#include <common>
		...
		`};new y;new y;new F;new F;new F;new y;new A;new ve;new y;new j;new re;new F;new A;new A;new ue;`${g.logdepthbuf_pars_vertex}${g.fog_pars_vertex}${g.logdepthbuf_vertex}${g.fog_vertex}`;`${g.tonemapping_fragment}${g.colorspace_fragment}`;`${g.tonemapping_fragment}${g.colorspace_fragment}`;const he=`
