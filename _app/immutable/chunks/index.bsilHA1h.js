import"./disclose-version.Bg9kRutz.js";import{ah as P,c as D,V as h,t as re,a3 as A,w as se,j as U,a1 as de,$ as T,W as j,a0 as fe,a2 as F,a4 as ve,M as ue,ai as g,C as pe,aj as xe,q as me,F as ee}from"./T.Hd49IpQl.js";const w=e=>({subscribe:e.subscribe,get current(){return e.current}});let z=0;const $=D(!1),R=D(!1),Y=D(void 0),q=D(0),K=D(0),ie=D([]),X=D(0),{onStart:k,onLoad:L,onError:Z}=P;P.onStart=(e,n,t)=>{k==null||k(e,n,t),R.set(!0),Y.set(e),q.set(n),K.set(t);const o=(n-z)/(t-z);X.set(o),o===1&&$.set(!0)};P.onLoad=()=>{L==null||L(),R.set(!1)};P.onError=e=>{Z==null||Z(e),ie.update(n=>[...n,e])};P.onProgress=(e,n,t)=>{n===t&&(z=t),R.set(!0),Y.set(e),q.set(n),K.set(t);const o=(n-z)/(t-z)||1;X.set(o),o===1&&$.set(!0)};w(R),w(Y),w(q),w(K),w(ie),w(X),w($);new h;new h;new h;new re;new A;new se;new h;new h;new h;new h;new U;new j;new h;T.line={worldUnits:{value:1},linewidth:{value:1},resolution:{value:new U(1,1)},dashOffset:{value:0},dashScale:{value:1},dashSize:{value:1},gapSize:{value:1}};fe.line={uniforms:de.merge([T.common,T.fog,T.line]),vertexShader:`
		#include <common>
		...
		`};new h;new h;new F;new F;new F;new h;new A;new ve;new h;new j;new re;new F;new A;new A;new ue;const ke=`
    #include <common>
...
`;`${g.tonemapping_fragment}${g.colorspace_fragment}`;`${g.tonemapping_fragment}${g.colorspace_fragment}`;const ye=`
